  ...
  try {
      ...
      for (const tag of metaTags) {
          ...
          if (property && content) {
              ...
              if (property === 'og:title') og.title = escapeHTML(content);
              if (property === 'og:image') og.image = content;
              if (property === 'og:description') og.description = escapeHTML(content);
              if (property === 'og:site_name') og.site_name = escapeHTML(content);
              if (property === 'author') og.author = escapeHTML(content);
          }
      }
